...
const actionType = 'personAccount/getInvestList';
...
const mapStateToProps = state => ({
  investList: state.personAccount.investList,
  investListFlag: state.personAccount.investListFlag,
...
const mapDispatchToProps = {
  ...
  changeInvestList: index => ({
    type: 'personAccount/changeInvestList',
    payload: index || null,
  }),
...
@withRouter
export default class PersonAccount extends PureComponent {
  static propTypes = {
